...
class TestSearchExecution:
    ...
    def test_empty_search_results(self, course_search_tool, mock_vector_store, mock_empty_search_results):
    ...
    def test_empty_results_with_filters(self, course_search_tool, mock_vector_store, mock_empty_search_results):
    ...
    def test_vector_store_error_handling(self, course_search_tool, mock_vector_store, mock_error_search_results):
...
class TestResultFormatting:
    ...
    def test_source_tracking_multiple_results(self, course_search_tool, mock_vector_store):
